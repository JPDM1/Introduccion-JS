...
// var n=50;
// for(let i=n-1;0<i;i--){if(i % 2==0){console.log(i)}};
...
// var n= 55;
// for(let i=1;i<=n;i++){if(i%2==0){console.log(`${i} es par`);
//                                 } else{console.log(`${i} no es par`)}};
...
// var num= 7;
// var sum=num;
// for (let i = 0; i < 100; i++) { if(sum<=100){console.log(sum);
//                                              sum +=num} else{break}};
// Imagen
let star= "*";
